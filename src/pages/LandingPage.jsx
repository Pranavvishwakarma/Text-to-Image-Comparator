  ...
  return (
    <div>
      <Helmet>
        ...
        <meta name="description" content="Generate AI Image using Text2Pic.ai" />
        <title>Home - Text2Visual generation Battle</title>
        <meta name="theme-color" content="#0a192f" />
        <link rel="shortcut icon" href='/favicon.ico' sizes="any" />
        <link rel="manifest" href="/manifest.json" />
        <meta httpEquiv="Content-Type" content="text/html; charset=UTF-8" />
        <meta name="author" content="Pranav Vishwakarma"></meta>
        <meta name="robots" content="index,follow" />
        <meta
          name="keywords"
          content="AI Artificial Intelligence Pranav Vishwakarma Developer OpenAi DALL-E image generator Aniyikaye coding web-development server MERN mongodb expressjs reactjs"
        />

        {/* Og */}
        <meta property="og:title" content="Home - Text2Pic.ai" />
        <meta
          property="og:description"
          content="Generate AI Image using Text2Pic.ai"
        />
        <meta property="og:site_name" content="Home - Text2Pic.ai" />
        ...
        <meta name="twitter:title" content="Home - Text2Pic.ai" />
        <meta
          name="twitter:description"
          content="Generate AI Image using Text2Visual generation Battle"
        /> */}
      ...
      <section className="w-full flex flex-col md:flex-row py-6 md:py-12 min-h-[70vh] items-center relative sm:px-20 px-6 font-poppins ">
        <div className="flex flex-col w-full md:w-6/12 relative">
          ...
          <p className="font-poppins text-slate text-[1.05rem] font-medium mt-7 ">
            ...
            <span className="font-poppins font-bold">Text2Visual</span> we'll help you
        ...
        <div className="flex w-full mt-16 md:mt-0 md:w-6/12 justify-center">
          <img
            ...
            alt="Text2Visual generation Battle"
        ...
        <div className="max-w-7xl mx-auto font-poppins lg:px-8 sm:px-20 px-6">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto font-poppins">
              Create imaginative and visually stunning images through Text2Visual generation Battle
        ...
        <div className="flex flex-col md:flex-row my-8 text-green_opaque mt-[4rem]">
          ...
          <div className="w-full md:w-6/12 flex flex-col justify-center my-6 md:my-0">
            ...
            <p className="text-slate md:pr-10 my-6 md:text-lg 2xl:text-xl font-poppins">
              ...
              they exist. @Pranavvishwakarma
            </p>
            <a
              href="https://github.com/pranavvishwakarma"
        ...
        <div className="bg-lightblue py-20 px-4 text-zinc-500">
          <div className="mx-auto max-w-6xl flex flex-col md:flex-row">
            ...
            <dl className="w-full md:w-2/3">
              ...
              {/* <dd className="mb-10 lg:mb-16 font-poppins">
                <p className="font-poppins">
                  Ping @ in your tweet following the prompt you'll like
                  to use.
                </p>
